...
Use these options to add releases, Git revisions and comparison policies to a
software suite. For a complete runnable example, start with
[comparing two versions](../tutorials/comparisons.md).
