...
Describe platform support and available interfaces for network-counter sampling.
This reports collection capability; interface counters include other traffic
using the same interface. Use network isolation for process-tree attribution.
"""
