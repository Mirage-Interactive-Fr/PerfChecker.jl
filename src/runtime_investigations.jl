...
Write `julia-investigation.json` and a Markdown attribution report in `directory`.
Create the directory, replace these report files and return both absolute paths.
This exports the supplied investigation without rerunning any runtime campaign.
"""
